...
namespace CustomBlazorTheme.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update CustomBlazorThemeDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update CustomBlazorThemeEfCoreEntityExtensionMappings to extend the IdentityUser entity
